...
| Sales CRM waves 0–3 | integrator | schema/src/crm-*.ts, engine/src/crm*.ts, engine/src/sync/netsuite-crm.ts, web/app/(app)/crm, web/app/(app)/admin/setup/crm, web/app/api/crm | DONE (0043 applied; setup lives in the main Setup workspace; live replay imported 1,014 accounts and 3,646 non-email typed legacy notes with account links, including 3,531 sales visits; source email history is intentionally excluded) |
