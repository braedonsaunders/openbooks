...
| Sales CRM waves 0–3 | integrator | schema/src/crm-*.ts, engine/src/crm*.ts, engine/src/sync/netsuite-crm.ts, web/app/(app)/crm, web/app/(app)/admin/setup/crm, web/app/api/crm | DONE (0043 applied; 1,014 source accounts + 12 statuses imported; setup lives in the main Setup workspace; source task/call/calendar/note content remains permission-blocked and is reported explicitly) |
