...
// the invoice drawer title row clipped the status pill to "Vo…"
...
test('drawer title row wraps instead of clipping the status pill', () => {
...
test('status pill never shrinks', () => {
  const html = titleHtml()
