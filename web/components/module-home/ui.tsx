...
const ICON_TONE: Record<DirectoryTone, string> = {
  neutral:
    "bg-teal-50 text-teal-700 ring-teal-100 dark:bg-teal-950/50 dark:text-teal-300 dark:ring-teal-900/50",
  positive:
  ...
  negative:
    "bg-red-50 text-red-700 ring-red-100 dark:bg-red-950/50 dark:text-red-300 dark:ring-red-900/50",
};
