...
// HR-20 begin: field-time islands (verbatim adapters only).
...
export const HRM_WIDGETS = {
  ...
  // HR-20 begin: field-time islands — loader-resolved display data only,
  // never org or user ids. Each island calls its own API routes.
