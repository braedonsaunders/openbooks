...
// HR-17 begin: continuous-performance islands (verbatim adapters only).
import {
...
export const HRM_WIDGETS = {
  ...
  // HR-17 begin: continuous performance — 1:1s, feedback, calibration,
  // talent review and succession (verbatim adapters only).
