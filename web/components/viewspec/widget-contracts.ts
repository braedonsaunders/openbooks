...
export const WIDGET_CONTRACTS: Readonly<Record<string, WidgetContract>> = {
  ...
  'hrm-add-position-button': { props: ['basePath', 'label'] },
  ...
  'hrm-leave-queue': { props: ['canFile', 'canRecord', 'columns', 'emptyDescription', 'emptyTitle', 'fileButton', 'fileTitle', 'notAvailable', 'openEmployee', 'recordButton', 'recordTitle', 'rows', 'truncated', 'truncatedNote'] },
  ...
  'hrm-position-segments': { props: ['ariaLabel', 'segments'] },
  'hrm-positions-table': { props: ['columns', 'empty', 'rows', 'totalLabel', 'totals'] },
  'hrm-process-drawer': { props: ['drawer'] },
  'hrm-process-segments': { props: ['ariaLabel', 'segments'] },
  'hrm-processes-table': { props: ['columns', 'empty', 'rows'] },
  'hrm-readiness': { props: ['docHref', 'docLabel', 'message', 'tone'] },
