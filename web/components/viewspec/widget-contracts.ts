...
export const WIDGET_CONTRACTS: Readonly<Record<string, WidgetContract>> = {
  ...
  'aging-strip': { props: ['asOfLabel', 'cells', 'total', 'totalDrill', 'totalLabel'] },
  ...
  'assistant-app': { props: ['activeId', 'aiEnabled', 'canConfigureAi', 'canWrite', 'conversations', 'initialFindingId', 'initialMessages', 'initialPrompt'] },
  ...
  'backup-manager': { props: ['policy', 'runs', 's3Enabled', 'totalRuns', 'workerOnline'] },
  ...
  'forecast-excluded-note': { props: ['href', 'linkLabel', 'note'] },
  ...
  'hrm-benefit-dialog': { props: ['closeHref', 'dialog'] },
  'hrm-benefits-panel': { props: ['missingCount', 'missingLabel', 'openEmpty', 'openLabel', 'openWindows', 'pendingCount', 'pendingLabel', 'queueHref', 'viewAllLabel'] },
  'hrm-calibration-distribution': { props: ['distribution', 'title'] },
  'hrm-calibration-entry': { props: ['editor'] },
  'hrm-calibration-missing': { props: ['missing', 'title'] },
  'hrm-change-request-actions': { props: ['appliedChangeId', 'canManage', 'departmentOptions', 'employmentId', 'requestId', 'requestStatus'] },
  'hrm-change-request-dialog': { props: ['canManage', 'closeHref', 'departmentOptions', 'requestId', 'subject'] },
  ...
  'hrm-cycle-drawer': { props: ['detail', 'loadError', 'missingDetail'] },
  'hrm-documents-drawer': { props: ['drawer'] },
  'hrm-documents-generate-dialog': { props: ['generate'] },
  'hrm-enrollment-actions': { props: ['approveLabel', 'canManage', 'enrollmentId', 'enrollmentStatus', 'failedLabel'] },
  'hrm-exit-drawer': { props: ['exit', 'loadError', 'missingExit'] },
  'hrm-explain-drawer': { props: ['explain'] },
  ...
  'hrm-placement-bar': { props: ['label', 'max', 'min', 'rate', 'target'] },
  'hrm-placement-summary': { props: ['bandRange', 'compaRatio', 'placement'] },
  'hrm-plan-line-approve': { props: ['approve', 'lineId', 'lineStatus', 'planId'] },
  ...
  'hrm-qualification-dialog': { props: ['canManage', 'closeHref', 'qualificationId', 'recordOpen'] },
  'hrm-qualification-requirement-manager': { props: ['labels', 'today', 'types'] },
  'hrm-qualification-requirement-remove': { props: ['canManage', 'confirmLabel', 'failedLabel', 'id', 'label'] },
  ...
  'hrm-review-acknowledge': { props: ['canAcknowledge', 'failedLabel', 'label', 'reviewId'] },
  'hrm-review-drawer': { props: ['loadError', 'missingReview', 'review'] },
  'hrm-session-actions': { props: ['closeLabel', 'failed', 'openLabel', 'sessionId', 'status'] },
  ...
  'new-dashboard': { props: [] },
  'new-document': { props: ['basePath', 'items', 'triggerLabel'] },
  'new-equipment': { props: ['currentParams'] },
  'new-expense': { props: [] },
  ...
  'new-journal': { props: [] },
  'new-movement': { props: [] },
  'new-order': { props: ['apiPath', 'base', 'createFailedMessage', 'createParam', 'label', 'param'] },
  'new-order-redirect': { props: ['apiPath', 'base', 'createFailedMessage', 'createParam', 'param'] },
  'new-party': { props: [] },
  ...
  'new-record': { props: ['basePath', 'currentParams', 'typeKey', 'typeName'] },
  ...
  'org-chart-tree': { props: ['chart', 'labels', 'personBaseHref'] },
  ...
  'payroll-anomaly-drawer': { props: ['closeHref', 'flag'] },
  'payroll-anomaly-scan': { props: ['currentParams', 'scanBusyLabel', 'scanFailedLabel', 'scanLabel'] },
  ...
  'reports-nl-ask': { props: ['ask', 'canCreate'] },
