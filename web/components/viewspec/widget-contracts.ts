...
export const WIDGET_CONTRACTS: Readonly<Record<string, WidgetContract>> = {
  ...
  'hrm-enrollment-actions': { props: ['approveLabel', 'canManage', 'enrollmentId', 'enrollmentStatus'] },
  'hrm-exit-drawer': { props: ['exit', 'missingExit'] },
  ...
  'hrm-leave-calendar': { props: ['basePath', 'currentParams', 'days', 'departmentLabel', 'departmentOptions', 'empty', 'fromLabel', 'notAvailable', 'showLabel', 'toLabel'] },
  'hrm-leave-dialog': { props: ['closeHref', 'requestId'] },
  ...
  'hrm-retention-panel': { props: ['retention'] },
  'hrm-review-acknowledge': { props: ['canAcknowledge', 'failedLabel', 'label', 'reviewId'] },
  'hrm-review-drawer': { props: ['missingReview', 'review'] },
  ...
  'inbox-task-list': { props: ['actedLabel', 'delegatePlaceholder', 'openLabel', 'refusedLabel', 'rows', 'users'] },
  ...
  'opportunity-kanban-board': { props: ['canManage', 'drawer', 'opportunities', 'statuses'], open: true },
  'opportunity-view-switcher': { props: ['view'] },
  'optional-badge': { props: ['label', 'variant'] },
  'order-drawer': { props: ['drawer'] },
  'org-chart-tree': { props: ['asOf', 'asOfLabel', 'chart', 'labels', 'personBaseHref', 'search', 'searchLabel', 'today'] },
