...
export const WIDGET_CONTRACTS: Readonly<Record<string, WidgetContract>> = {
  ...
  'customer-view': { props: ['canConfigure', 'data', 'profitability', 'projectsEnabled'] },
  ...
  'financial-health-view': { props: ['budgetsEnabled', 'canConfigure', 'data', 'defs'] },
  ...
  'opening-balances-grid': { props: ['accountPrograms', 'canManage', 'components', 'currentYear', 'fields', 'initial', 'programs', 'suiStates', 'year'] },
  ...
  'sentinel-view': { props: ['canConfigure', 'data'] },
