...
const RAW_DOC_ARTICLES: DocArticle[] = [
  ...
  bankingAndReconciliation,
  periodClose,
  projectTypes, overheadCosting, laborCosting, laborPricing, payroll, employmentMigration, positionsAndHeadcount, fieldTickets, subcontractorCompliance,
  projectTypes, overheadCosting, laborCosting, laborPricing, payroll, hrmProcesses, fieldTickets, subcontractorCompliance,
  itemRates,
  financialReports,
