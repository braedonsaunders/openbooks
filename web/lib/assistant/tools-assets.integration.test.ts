...
test('asset reads: register totals, drawer detail, and subsidiary isolation', { skip: !process.env.OPENBOOKS_DB_URL }, async () => {
  ...
  try {
    await withOrgContext(org.orgId, async () => {
      ...
      `);
      await db.execute(sql`
        insert into tax_pool_periods(id,org_id,pool_id,tax_year,opening_balance,additions,dispositions,net_additions,immediate_expense,base,allowance,closing_balance,recapture,terminal_loss,short_year_factor,year_start,year_end)
        values (${randomUUID()},${org.orgId},${poolId},2025,'1000','0','0','0','0','1000','100','900','0','0','1','2025-01-01','2025-12-31'),
               (${randomUUID()},${org.orgId},${hiddenPoolId},2025,'9000','0','0','0','0','9000','900','8100','0','0','1','2025-01-01','2025-12-31')
      `);
    });
