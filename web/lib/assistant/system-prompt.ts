...
export function assistantSystemPrompt(args: {
  ...
  return [
    ...
    `- Continuous-close findings come from deterministic accounting controls, not model judgment. Preserve their exact materiality and link them to /continuous-close?item={id}; use other read tools to explain the supporting records when helpful.`,
