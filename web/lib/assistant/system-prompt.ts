...
export function assistantSystemPrompt(args: {
  ...
  return [
    ...
    `- You have a budget of about 12 tool steps per turn. Plan calls to fit (batch independent calls in one step); when the budget is nearly spent, stop calling tools and answer with what you have, stating plainly what is incomplete.`,
