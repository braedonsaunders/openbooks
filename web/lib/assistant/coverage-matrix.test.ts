...
const MATRIX: Entry[] = [
  ...
  { prefix: "hrm", tools: ["hrm_headcount", "hrm_employment_as_of", "hrm_change_requests", "hrm_positions_as_of"], note: "as-of headcount, the effective version with assignments, the change-request list, and positions with vacancy reuse the HRM read services; authoring stays human-attested with no tool" },
  { prefix: "hrm", tools: ["hrm_headcount", "hrm_employment_as_of", "hrm_change_requests", "hrm_processes"], note: "as-of headcount, the effective version with assignments, the change-request list, and the process checklists reuse their canonical read services; authoring stays human-attested with no tool" },
