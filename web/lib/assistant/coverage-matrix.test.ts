...
const MATRIX: Entry[] = [
  ...
  { prefix: "hrm", tools: ["hrm_headcount", "hrm_employment_as_of", "hrm_change_requests"], note: "as-of headcount, the effective version with assignments, and the change-request list reuse the employment read service; authoring stays human-attested with no tool" },
