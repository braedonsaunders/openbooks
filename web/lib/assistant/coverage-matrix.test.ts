...
const MATRIX: Entry[] = [
  ...
  { prefix: "v1/banking", tools: ["start_reconciliation", "match_bank_line", "match_bank_line_with_journal", "unmatch_bank_line", "sign_off_reconciliation", "list_bank_reconciliations", "get_bank_reconciliation", "list_unmatched_bank_lines", "list_bank_feeds"] },
  { prefix: "v1/budgets", tools: ["list_budget_scenarios", "get_budget_scenario", "update_budget_cells"] },
  { prefix: "v1/files", tools: ["list_files", "get_file", "list_folders", "upload_file"] },
  { prefix: "v1/close", tools: ["list_close_runs", "get_close_run", "start_close_run", "request_period_reopen", "decide_period_reopen", "run_revaluation", "list_period_locks", "list_period_reopen_requests"] },
  { prefix: "v1/admin", tools: ["list_users", "list_roles", "search_audit_log"] },
  { prefix: "v1/opportunities", tools: ["search_opportunities", "get_opportunity"] },
  { prefix: "v1/crm", tools: ["search_crm_accounts", "get_crm_account"] },
  { prefix: "v1/aging", tools: ["aging", "aging_detail"] },
  { prefix: "v1/trial-balance", tools: ["trial_balance"] },
  { prefix: "v1/statements", tools: ["partner_statement"] },
  { prefix: "v1/customers", tools: ["find_parties"] },
  { prefix: "v1/vendors", tools: ["find_parties"] },
  { prefix: "v1/employees", tools: ["find_parties"] },
  ...
  { prefix: "v1/open-items", tools: ["list_open_items"] },
  { prefix: "v1/currencies", tools: ["list_currencies"] },
  ...
  { prefix: "v1/tax", tools: ["list_tax_return_forms", "tax_return"] },
