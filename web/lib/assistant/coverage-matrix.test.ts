...
const MATRIX: Entry[] = [
  ...
  { prefix: "v1/files", tools: ["list_files", "upload_file"] },
  { prefix: "v1/close", tools: ["list_close_runs", "get_close_run", "start_close_run", "request_period_reopen", "decide_period_reopen", "run_revaluation", "list_period_locks"] },
  { prefix: "v1/admin", tools: ["list_users", "list_roles", "search_audit_log"] },
  { prefix: "v1/opportunities", tools: ["search_opportunities"] },
