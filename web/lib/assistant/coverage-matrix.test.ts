...
const MATRIX: Entry[] = [
  ...
  { prefix: "hrm", tools: ["hrm_headcount", "hrm_employment_as_of", "hrm_change_requests", "hrm_positions_as_of", "hrm_processes", "hrm_leave", "hrm_recruiting", "hrm_performance_cycles", "hrm_turnover", "hrm_benefits"], note: "as-of headcount, the effective version with assignments, the change-request list, positions with vacancy, the process checklists, leave requests with balances, requisitions with the funnel, review cycles with progress, turnover, and benefit elections reuse their canonical HRM read services; authoring stays human-attested with no tool" },
  { prefix: "hrm", tools: ["hrm_headcount", "hrm_employment_as_of", "hrm_change_requests", "hrm_positions_as_of", "hrm_processes", "hrm_leave", "hrm_me"], note: "as-of headcount, the effective version with assignments, the change-request list, positions with vacancy, the process checklists, leave requests with balances, and the caller's own employment summary reuse their canonical HRM read services; authoring stays human-attested with no tool" },
