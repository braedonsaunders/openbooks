...
const MATRIX: Entry[] = [
  ...
  { prefix: "allocations", tools: ["run_report", "list_report_definitions"], note: "allocation runs and lineage are report entities (Allocation summary / lineage built-ins); rule, driver, preview and explain tools land with the A13 allocations tool module" },
