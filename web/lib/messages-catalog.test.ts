...
test('payroll copy ships translated in ja, zh and pt-BR', () => {
  ...
  assert.equal(I7_WANTED.length, 1089, 'payroll source inventory changed; translate the new keys in ja/zh/pt-BR and re-pin')
...
test('I6 payroll copy ships translated in fr, es and de', () => {
  ...
  assert.equal(I6_wanted.length, 1089, 'payroll source inventory changed; translate the new keys in fr/es/de and re-pin')
