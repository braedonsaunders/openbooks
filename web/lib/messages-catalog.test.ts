...
const I14_IDENTICAL_BY_FACT = new Set([
  // HR-21 begin: natural-language report drafts and the AI ledger
  // catalog. "Status" and "Name" are the German words; "Question" is
  // the French word. All three are spelled as in English.
