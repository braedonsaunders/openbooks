...
// An Approved sales order was a dead end — Convert to Invoice
...
// drawer. All seven locales must label every conversion target, including
// the purchase-receipt key that only English translated before.
