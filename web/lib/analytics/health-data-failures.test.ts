...
const mocks: Record<string, string> = {
  "server-only": "export {}",
  "@openbooks/engine/src/db.ts": `export function ambientTenantOrgId(){return null} export function registerRequestOrgResolver(){} export async function withBypassContext(work){return work()} export const db={async execute(query){
