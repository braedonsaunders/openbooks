...
export const MCP_SKILLS: readonly McpSkill[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "4. The approval chain is deliberate and ordered: request_close_approval, then attest_close_run, then close_period, then publish_close_package. Each step is gated by its own permission and may await other humans. Report where the run stands; never present a step you skipped as done.",
