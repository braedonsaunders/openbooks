...
export default async function Reports() {
  ...
  const reports = [
    ...
    { href: `/reports/general-ledger`, title: t('hub.cards.generalLedgerTitle'), desc: t('hub.cards.generalLedgerDescription') },
    { href: `/reports/journal`, title: t('hub.cards.journalTitle'), desc: t('hub.cards.journalDescription') },
    { href: `/reports/registers?side=ar`, title: t('hub.cards.registersTitle'), desc: t('hub.cards.registersDescription') },
    { href: `/reports/budget`, title: t('hub.cards.budgetTitle'), desc: t('hub.cards.budgetDescription') },
