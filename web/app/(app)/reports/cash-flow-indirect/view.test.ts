...
// F-t06-025: enabling Multi-subsidiary crashed the indirect cash flow statement with
// React error 441 — the same MissingRatesError out of SSR as TB/P&L. The
// loader must convert the typed rates refusal into a banner with a derive
// link and never throw it.
