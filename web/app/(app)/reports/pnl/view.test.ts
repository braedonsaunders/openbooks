...
// 'No consolidated exchange rates … Derive rates from period close first.'
// threw out of SSR. The loader must convert the typed rates refusal into a
// banner with a derive link and never throw it.
