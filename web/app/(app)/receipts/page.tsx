    ...
    <ListPageLayout
      header={
        <><PageHeader
          ...
          actions={
            view === 'receipts' ? <NewPaymentButton kind="customer_payment" basePath="/receipts" label={t('page.newReceipt')} /> : <Button asChild size="sm"><Link href={mergeHref('/receipts', sp, { view: 'runs', newRun: '1', run: undefined }) as any}><Plus size={16} />{t('page.newCollectionRun')}</Link></Button>
          }
