 ...
 *
 * The related-transaction drawer is placed through the shared
 * `related-txn-drawer` slot, which re-derives `Authz` server-side. A capability
 * object is not data and never travels through a spec.
 */
