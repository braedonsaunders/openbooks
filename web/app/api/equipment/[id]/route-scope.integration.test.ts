...
test('equipment GET answers an out-of-scope unit exactly like a missing one', async () => {
...
test('equipment GET waits on a unit rehome in flight instead of racing it', async () => {
  const org = await createScratchOrg()
