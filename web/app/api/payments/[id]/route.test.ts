...
const mockUrls = new Map<string, string>([
  ...
  ['@openbooks/engine/src/payments/payment-accounts.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/payment-contracts.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/payment-documents.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/payment-errors.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/payment-posting.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/payment-queries.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/payment-return.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/rail-cpa005.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/rail-nacha.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/rail-sepa.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/rail-cemtex.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/rail-settings.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/run-cancellation.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/run-creation.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/run-files.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/run-posting.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/run-readiness.ts', 'mock:payments-engine'],
  ['@openbooks/engine/src/payments/settlement-policy.ts', 'mock:payments-engine'],
