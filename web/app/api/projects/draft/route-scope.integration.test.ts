...
async function setup() {
  ...
  const actor = await withBypassContext(() => (createScratchUser(org.orgId, 'Project drafter', 'reviewer')))
...
test('a restricted project draft lands in their own subsidiary', async () => {
...
test('a project draft with no assignable subsidiary refuses by name and stores nothing', async () => {
