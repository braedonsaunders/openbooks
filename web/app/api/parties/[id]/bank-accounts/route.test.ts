...
const mockUrls = new Map<string, string>([
  ...
  ['@openbooks/engine/src/payments/payment-errors.ts', mockUrl('payments')],
  ...
  ['@openbooks/engine/src/payments/rail-cpa005.ts', mockUrl('payments')],
  ['@openbooks/engine/src/payments/rail-nacha.ts', mockUrl('payments')],
  ['@openbooks/engine/src/payments/rail-sepa.ts', mockUrl('payments')],
  ['@openbooks/engine/src/payments/rail-cemtex.ts', mockUrl('payments')],
  ['@openbooks/engine/src/payments/rail-settings.ts', mockUrl('payments')],
