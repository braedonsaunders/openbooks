...
if (!isVitest) {
  ...
  collectionRoute = (await import("./route.ts?hrm-recruiting-candidates-collection")) as typeof import("./route.ts");
  itemRoute = (await import("./[id]/route.ts?hrm-recruiting-candidates-item")) as typeof import("./[id]/route.ts");
  hooks.deregister();
}
