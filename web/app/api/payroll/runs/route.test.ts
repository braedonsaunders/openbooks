...
const mockUrls = new Map<string, string>([
  ...
  ['@openbooks/engine/src/payroll/fences.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-allocation.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-calculation-evidence.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-calculation.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-calendar.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-commit.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-contracts.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-lifecycle.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-protection.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-setup.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/run-stub-records.ts', 'mock:payroll-run'],
  ['@openbooks/engine/src/payroll/scope.ts', 'mock:payroll-run'],
