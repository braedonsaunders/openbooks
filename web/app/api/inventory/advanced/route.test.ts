...
const mockUrls = new Map<string, string>([
  ...
  ["@openbooks/engine/src/inventory/assembly.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/contracts.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/costing.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/document-lines.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/documents-purchasing.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/documents-sales.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/documents-vendor-credits.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/journal.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/landed-cost.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/movements.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/position.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/profile-policy.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/revaluation.ts", "mock:inventory"],
  ["@openbooks/engine/src/inventory/reversal.ts", "mock:inventory"],
  ...
  ["@openbooks/engine/src/inventory/transfers.ts", "mock:inventory"],
  ["@openbooks/engine/src/money/money.ts", "mock:inventory"],
