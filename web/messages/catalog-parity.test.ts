...
const COGNATES = new Set<string>([
  ...
  'es:payroll.settingsPage.employerFacts.no|No',
  ...
  'de:close.problems.entityFailed|{name}: {detail}',
  ...
  'es:close.problems.entityFailed|{name}: {detail}',
  ...
  'pt-BR:close.problems.entityFailed|{name}: {detail}',
  ...
  'de:hrm.positions.manage.status|Status',
  ...
  'fr:hrm.qualifications.requirementManager.subjects.classification|Classification',
  ...
  'fr:reports.journal.origins.document|Document',
  'fr:reports.journal.origins.migration|Migration',
  ...
  'de:reports.journal.origins.migration|Migration',
  ...
  'es:reports.journal.origins.manual|Manual',
  ...
  'pt-BR:reports.journal.origins.manual|Manual',
  ...
  'de:pdfTemplates.list.paperA4|A4',
  'de:pdfTemplates.list.paperLegal|Legal',
  'de:pdfTemplates.list.paperLetter|Letter',
  'de:pdfTemplates.pdfButton.label|PDF',
  'es:pdfTemplates.editor.code|HTML',
  'es:pdfTemplates.list.paperA4|A4',
  'es:pdfTemplates.list.paperLegal|Legal',
  ...
  'pt-BR:pdfTemplates.list.paperA4|A4',
  'pt-BR:pdfTemplates.pdfButton.label|PDF',
  'zh:pdfTemplates.editor.code|HTML',
  'zh:pdfTemplates.list.paperA4|A4',
  'zh:pdfTemplates.list.paperLegal|Legal',
  'zh:pdfTemplates.list.paperLetter|Letter',
