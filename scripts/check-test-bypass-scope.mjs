...
// 127 files, 1011 unscoped writes.
export const BASELINE_EXPOSED = new Map([
  ...
  ["web/app/api/payroll/profiles/route.integration.test.ts", { writes: 5, via: "route.ts -> authz.ts -> auth.ts" }],
  ...
  ["web/lib/analytics-calendar.integration.test.ts", { writes: 1, via: "financial-health.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/analytics-ledger.integration.test.ts", { writes: 12, via: "customer-data.ts -> core.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/analytics-payment-scope.integration.test.ts", { writes: 9, via: "customer-data.ts -> core.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/analytics-scope.integration.test.ts", { writes: 12, via: "customer-data.ts -> core.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/analytics/customer-dso-unified.integration.test.ts", { writes: 12, via: "core.ts -> org-scope.ts -> auth.ts" }],
  ...
  ["web/lib/assistant/tools-admin-scope.integration.test.ts", { writes: 12, via: "registry.ts -> authz.ts -> auth.ts" }],
  ["web/lib/assistant/tools-allocations.integration.test.ts", { writes: 10, via: "registry.ts -> authz.ts -> auth.ts" }],
  ...
  ["web/lib/assistant/tools-party-scope.integration.test.ts", { writes: 5, via: "registry.ts -> tools.ts -> data.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/assistant/tools-property.integration.test.ts", { writes: 18, via: "registry.ts -> authz.ts -> auth.ts" }],
  ["web/lib/assistant/tools-subcontracts.integration.test.ts", { writes: 2, via: "registry.ts -> authz.ts -> auth.ts" }],
  ["web/lib/assistant/tools-subscriptions.integration.test.ts", { writes: 11, via: "registry.ts -> authz.ts -> auth.ts" }],
  ["web/lib/assistant/tools-subsidiary-leak.integration.test.ts", { writes: 17, via: "registry.ts -> tools.ts -> data.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/assistant/tools-time.integration.test.ts", { writes: 12, via: "registry.ts -> authz.ts -> auth.ts" }],
  ["web/lib/billing-request-scope.integration.test.ts", { writes: 15, via: "route.ts -> billing.ts -> bills.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/cash-ledger.integration.test.ts", { writes: 18, via: "core.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/cash-payment-scope.integration.test.ts", { writes: 7, via: "core.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/cash-scope.integration.test.ts", { writes: 12, via: "cashflow-data.ts -> core.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/continuous-close-agents.integration.test.ts", { writes: 7, via: "registry.ts -> tools.ts -> data.ts -> org-scope.ts -> auth.ts" }],
  ...
  ["web/lib/customer-payment-cutoff.integration.test.ts", { writes: 9, via: "customer-data.ts -> core.ts -> org-scope.ts -> auth.ts" }],
  ...
  ["web/lib/health-ledger.integration.test.ts", { writes: 7, via: "health-data.ts -> financial-health.ts -> org-scope.ts -> auth.ts" }],
  ...
  ["web/lib/payroll-run-holiday-eligibility.integration.test.ts", { writes: 5, via: "route.ts -> authz.ts -> auth.ts" }],
  ...
  ["web/lib/sentinel-access.integration.test.ts", { writes: 7, via: "registry.ts -> tools.ts -> data.ts -> org-scope.ts -> auth.ts" }],
  ["web/lib/statement-book-selection.integration.test.ts", { writes: 4, via: "authz.ts -> auth.ts" }],
  ["web/lib/utilization-scope.integration.test.ts", { writes: 9, via: "registry.ts -> tools.ts -> data.ts -> org-scope.ts -> auth.ts" }],
