...
test("fresh installations have exactly one canonical prerelease baseline", () => {
  ...
  assert.deepEqual(generated, [
    ...
    // in storage (G4), fences amend-deletes by the soft-close-aware
    // predicate like amend-updates (G5), and follows book rehomes in the
    // GL monthly aggregate (G6). Further wave-G sections land in the same
    // file under later commits, each extending this note to match.
