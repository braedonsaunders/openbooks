...
-- A depreciation fact is not evidence-backed merely because it contains a
-- human-entered reference. The referenced file must exist in the same tenant
-- and be attached to the owning fixed asset.
