...
-- CRM relationship lifecycle, activity, pipeline, and forecast domains.
alter table crm_account_statuses add foreign key (org_id) references orgs(id) on delete cascade;
alter table crm_lead_sources add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (parent_id) references crm_lead_sources(id) on delete restrict;
alter table crm_sales_territories add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (parent_id) references crm_sales_territories(id) on delete restrict, add foreign key (manager_user_id) references users(id) on delete set null, add foreign key (default_owner_user_id) references users(id) on delete set null;
alter table crm_account_profiles add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (party_id) references parties(id) on delete cascade, add foreign key (status_id) references crm_account_statuses(id) on delete restrict, add foreign key (owner_user_id) references users(id) on delete set null, add foreign key (territory_id) references crm_sales_territories(id) on delete set null, add foreign key (lead_source_id) references crm_lead_sources(id) on delete set null;
alter table crm_account_stage_events add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (account_profile_id) references crm_account_profiles(id) on delete cascade;
alter table crm_account_assignment_events add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (account_profile_id) references crm_account_profiles(id) on delete cascade;
alter table crm_activities add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (owner_user_id) references users(id) on delete set null, add foreign key (assigned_user_id) references users(id) on delete set null;
alter table crm_activity_links add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (activity_id) references crm_activities(id) on delete cascade;
alter table crm_activity_participants add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (activity_id) references crm_activities(id) on delete cascade, add foreign key (user_id) references users(id) on delete cascade, add foreign key (contact_id) references contacts(id) on delete cascade;
alter table crm_opportunity_statuses add foreign key (org_id) references orgs(id) on delete cascade;
alter table crm_sales_teams add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (manager_user_id) references users(id) on delete set null, add foreign key (parent_team_id) references crm_sales_teams(id) on delete restrict;
alter table crm_sales_team_members add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (team_id) references crm_sales_teams(id) on delete cascade, add foreign key (user_id) references users(id) on delete cascade;
alter table crm_opportunities add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (party_id) references parties(id) on delete restrict, add foreign key (primary_contact_id) references contacts(id) on delete set null, add foreign key (owner_user_id) references users(id) on delete set null, add foreign key (sales_team_id) references crm_sales_teams(id) on delete set null, add foreign key (status_id) references crm_opportunity_statuses(id) on delete restrict, add foreign key (lead_source_id) references crm_lead_sources(id) on delete set null, add foreign key (subsidiary_id) references subsidiaries(id) on delete restrict, add foreign key (department_id) references departments(id) on delete restrict, add foreign key (location_id) references locations(id) on delete restrict, add foreign key (class_id) references classes(id) on delete restrict;
alter table crm_opportunity_lines add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (opportunity_id) references crm_opportunities(id) on delete cascade, add foreign key (item_id) references items(id) on delete restrict;
alter table crm_opportunity_team_members add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (opportunity_id) references crm_opportunities(id) on delete cascade, add foreign key (user_id) references users(id) on delete restrict;
alter table crm_opportunity_documents add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (opportunity_id) references crm_opportunities(id) on delete cascade, add foreign key (document_id) references documents(id) on delete cascade;
alter table crm_opportunity_stage_events add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (opportunity_id) references crm_opportunities(id) on delete cascade, add foreign key (from_status_id) references crm_opportunity_statuses(id) on delete restrict, add foreign key (to_status_id) references crm_opportunity_statuses(id) on delete restrict;
alter table crm_sales_quotas add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (owner_user_id) references users(id) on delete restrict, add foreign key (sales_team_id) references crm_sales_teams(id) on delete restrict;
alter table crm_forecast_snapshots add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (owner_user_id) references users(id) on delete restrict, add foreign key (sales_team_id) references crm_sales_teams(id) on delete restrict;

-- AP document capture: source files and immutable extraction/review evidence.
alter table ap_capture_items add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (file_id) references files(id) on delete restrict, add foreign key (vendor_candidate_id) references parties(id) on delete restrict, add foreign key (purchase_order_id) references documents(id) on delete restrict, add foreign key (document_id) references documents(id) on delete restrict, add foreign key (assigned_to) references users(id) on delete set null, add foreign key (created_by) references users(id) on delete set null, add foreign key (updated_by) references users(id) on delete set null;
alter table ap_capture_runs add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (capture_item_id) references ap_capture_items(id) on delete cascade, add foreign key (created_by) references users(id) on delete set null;
alter table ap_capture_fields add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (run_id) references ap_capture_runs(id) on delete cascade;
alter table ap_capture_corrections add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (capture_item_id) references ap_capture_items(id) on delete cascade, add foreign key (corrected_by) references users(id) on delete restrict;
alter table ap_capture_rules add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (created_by) references users(id) on delete set null, add foreign key (updated_by) references users(id) on delete set null;
alter table ap_capture_events add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (capture_item_id) references ap_capture_items(id) on delete cascade, add foreign key (actor_id) references users(id) on delete set null;

-- Project billing: requests → generated customer_invoice documents, milestone
-- schedules, and persisted invoice backup packages (file cabinet).
alter table billing_requests add foreign key (org_id) references orgs(id) on delete cascade, add foreign key (project_id) references projects(id) on delete cascade, add foreign key (invoice_document_id) references documents(id) on delete set null, add foreign key (created_by) references users(id) on delete set null, add foreign key (updated_by) references users(id) on delete set null;
