 ...
 * Run: npx tsx verify-subsidiaries.mts <sandbox-or-preview-org-id>
 */
...
const first = await withOrg(org.id, () => runAutoElimination(org.id, periodId, undefined));
...
const second = await withOrg(org.id, () => runAutoElimination(org.id, periodId, undefined));
