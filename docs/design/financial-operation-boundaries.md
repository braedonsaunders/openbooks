...
| Payments | payment-creation/documents/posting/return and run-creation/readiness/claim/posting/cancellation/remittance/files | Existing posting transactions and claim fences remain with the operation that owns the lifecycle transition. |
