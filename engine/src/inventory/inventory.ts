...
import { type InventoryProfile, InventoryError, InventoryOwnershipError, type Runner } from "./contracts.ts";
import { inventoryRequestHash } from "./action-idempotency.ts";
import { assertTracking } from "./tracking.ts";
import { assertStockLocationAdmitsSubsidiary, assertNoForeignOnHand, resolveProfile } from "./profile-policy.ts";
import { type JournalLineInput, stockLocationDim, assertInventoryAccountsPostable, postInventoryEntry } from "./journal.ts";
export { stockLocationDim, postInventoryEntry } from "./journal.ts";
export { assertStockLocationAdmitsSubsidiary, type CostingMethod, type TrackingMode, type ItemInventoryProfileRow, parseCostingMethod, parseTrackingMode, lockItemInventoryProfile, type CostingPolicyAssessment, assertCostingPolicyChangeAllowed } from "./profile-policy.ts";
export { assertTracking, ensureLot, ensureSerial, type LotRecallFilter, type LotRecallRow, queryLotRecall } from "./tracking.ts";
export { type IdempotentInventoryAction, executeIdempotentInventoryAction } from "./action-idempotency.ts";
export { type InventoryAccounts, type InventoryProfile, InventoryError, InventoryOwnershipError, InventoryIdempotencyConflictError, CostingPolicyChangeBlockedError } from "./contracts.ts";
/**
 ...
 *   - moving_average:  one running pool per item+location, cost re-blended.
 *                      Adjacent-rate fragments retain exact carried value;
 *                      transit shipments retain separate source evidence.
