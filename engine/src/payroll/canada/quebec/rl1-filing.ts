 ...
 *
 * The slip data builder lives in engine/src/payroll/canada/quebec/rl1.ts; the transmission
 * mechanics and the XML refusal in engine/src/payroll/canada/quebec/rl1xml.ts. No download
