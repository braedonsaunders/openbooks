...
export const PL_REFUSALS_2026: readonly string[] = [
  ...
  "FP PUP-hire exemption (art. 262): needs a hiring channel no pack carries — the engine prices the standard FP-liable employee",
  "FP/FS return-from-leave exemption (art. 263): channeled — assert the leave-end month on parentalLeaveEnd and the engine zeroes FP/FS for the 36-month window (FS shares the exemption per the ZUS contribution guide §IV)",
