...
export const PL_REFUSALS_2025: readonly string[] = [
  ...
  "FP PUP-hire exemption (promotion act art. 104c; labour-market act art. 262 from 1 June 2025): needs a hiring channel no pack carries — the engine prices the standard FP-liable employee",
  "FP/FS return-from-leave exemption (promotion act art. 104a; labour-market act art. 263 from 1 June 2025): channeled — assert the leave-end month on parentalLeaveEnd and the engine zeroes FP/FS for the 36-month window (FS shares the exemption per the ZUS contribution guide §IV)",
