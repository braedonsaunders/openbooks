...
import { payrollCertificate, resolveCertificate, type ResolvedCertificate, type StoredCertificate } from "./certificates.ts";
import { assertContributoryBasesDeclared, ensurePackSlotRoleAccounts, jurisdictionKey, labourJurisdictionProblem, legacyStatutoryLiabilityAccount, packRates, packStatutoryComponents, PayrollJurisdictionError, PayrollPackError, payrollJurisdictionDeclared, payrollPack, assertPayrollRegionSupported, resolveEmployeePayrollContext, resolvePayrollRunContext, PAYROLL_COUNTRY_PACKS, type EmployeePayrollContext, type PayrollAssessedOn, type PayrollDeductionTreatment, type PayrollRunContext } from "./packs.ts";
import { assertConfiguredStatutoryRates, resolveStatutoryRates, type StatutoryRateResolution } from "./statutory-rates.ts";
...
import { effectivePayRateSql, payRateIsUsable } from "./rate.ts";
...
import { convertLaborWage, laborCostingSettings } from "../projects/labor-costing.ts";
...
import { entitlementBalances, entitlementPlans, planMovementsForStub, recordEntitlementMovements, vacationPlanOf, type EntitlementPlan, type EntitlementWarning } from "./entitlements.ts";
import { payrollPaymentMethodSettings, resolvePayrollPaymentMethod } from "./payment-method.ts";
import { applyBasisCaps, applyDeductionProtection, assertEarningsAssessedStable, dropIncomeAssessedLines, protectedBase, protectionConverged, protectionNeedsIteration, PROTECTION_MAX_PASSES, settleProtectionOscillation, totalShortfall, type DeductionShortfall, type EarningsAssessedLine, type ProtectionBase } from "./limits.ts";
import { protectionTreatmentIterates, reduceTaxBases } from "./treatment-bases.ts";
