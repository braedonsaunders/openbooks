...
import { OK_CERTIFICATE, OK_REGION } from "./states/ok.ts";
...
import { WI_CERTIFICATE, WI_REGION, WI_W220, WI_W221 } from "./states/wi.ts";
...
const US_CERTIFICATES: PayrollPackCertificates = {
  ...
  certificates: [
    ...
    MO_CERTIFICATE, MS_CERTIFICATE, MT_CERTIFICATE, ND_CERTIFICATE, ND_NDWM_CERTIFICATE, NE_CERTIFICATE, NM_CERTIFICATE, OK_CERTIFICATE,
    AZ_CERTIFICATE, IN_CERTIFICATE, KY_CERTIFICATE, VA_CERTIFICATE, WV_CERTIFICATE, WV_IT104NR_CERTIFICATE,
    UT_CERTIFICATE, MN_CERTIFICATE, MN_MWR, WI_CERTIFICATE, WI_W220, WI_W221, IA_CERTIFICATE, IA_44016,
  ],
};
