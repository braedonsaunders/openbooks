...
import { WV_CERTIFICATE, WV_IT104NR_CERTIFICATE, WV_MOBILE_CERTIFICATE, WV_REGION } from "./states/wv.ts";
...
const US_CERTIFICATES: PayrollPackCertificates = {
  ...
  certificates: [
    ...
    AZ_CERTIFICATE, IN_CERTIFICATE, KY_CERTIFICATE, KY_LOCALITY_RECORD, VA_CERTIFICATE, WV_CERTIFICATE, WV_IT104NR_CERTIFICATE, WV_MOBILE_CERTIFICATE,
