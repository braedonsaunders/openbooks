...
import { ND_CERTIFICATE, ND_NDWM_CERTIFICATE, ND_NDWR_CERTIFICATE, ND_REGION, ND_TRIBAL_CERTIFICATE } from "./states/nd.ts";
...
import { WV_CERTIFICATE, WV_IT104NR_CERTIFICATE, WV_REGION } from "./states/wv.ts";
...
const US_CERTIFICATES: PayrollPackCertificates = {
  ...
  certificates: [
    ...
    MO_CERTIFICATE, MS_CERTIFICATE, MT_CERTIFICATE, ND_CERTIFICATE, ND_NDWM_CERTIFICATE, ND_NDWR_CERTIFICATE, ND_TRIBAL_CERTIFICATE, NE_CERTIFICATE, NM_CERTIFICATE, OK_CERTIFICATE, OK_OW9MSE_CERTIFICATE,
    AZ_CERTIFICATE, IN_CERTIFICATE, KY_CERTIFICATE, KY_LOCALITY_RECORD, VA_CERTIFICATE, WV_CERTIFICATE, WV_IT104NR_CERTIFICATE,
