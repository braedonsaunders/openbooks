...
const US_CERTIFICATES: PayrollPackCertificates = {
  ...
  certificates: [
    ...
    MO_CERTIFICATE, MS_CERTIFICATE, MT_CERTIFICATE, ND_CERTIFICATE, ND_MOBILE_CERTIFICATE, ND_NDWM_CERTIFICATE, ND_NDWR_CERTIFICATE, ND_TRIBAL_CERTIFICATE, NE_CERTIFICATE, NM_CERTIFICATE, OK_CERTIFICATE, OK_OW9MSE_CERTIFICATE,
