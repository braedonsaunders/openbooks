...
import { ND_CERTIFICATE, ND_MOBILE_CERTIFICATE, ND_NDWM_CERTIFICATE, ND_NDWR_CERTIFICATE, ND_REGION, ND_TRIBAL_CERTIFICATE } from "./states/nd.ts";
...
const US_CERTIFICATES: PayrollPackCertificates = {
  ...
  certificates: [
    ...
    MO_CERTIFICATE, MS_CERTIFICATE, MT_CERTIFICATE, ND_CERTIFICATE, ND_MOBILE_CERTIFICATE, ND_NDWM_CERTIFICATE, ND_NDWR_CERTIFICATE, ND_TRIBAL_CERTIFICATE, NE_CERTIFICATE, NE_9N_CERTIFICATE, NM_CERTIFICATE, OK_CERTIFICATE, OK_OW9MSE_CERTIFICATE, OK_SERVICE_CLASS_CERTIFICATE,
