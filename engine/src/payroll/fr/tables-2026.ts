...
export const FR_REFUSED_2026: readonly string[] = [
  ...
  "URSSAF cotisations transcribed in ./cotisations-2026.ts and AGIRC-ARRCO (T1/T2, CEG, CET) plus covered APEC (4 PASS, cadre status declared) in ./retraite-2026.ts; still refused: AT/MP and versement mobilité (tenant-declared by design), and the Alsace-Moselle 1,30 % salary supplement (no department channel)",
