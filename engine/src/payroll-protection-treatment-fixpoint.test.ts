...
import { AU_PAYROLL_PACK } from "./payroll/au/pack.ts";
import { calculateAu2027 } from "./payroll/au/compute-statutory.ts";
import { reduceTaxBases } from "./payroll/treatment-bases.ts";
import { settleDeductionProtection, type Line } from "./payroll-run.ts";
