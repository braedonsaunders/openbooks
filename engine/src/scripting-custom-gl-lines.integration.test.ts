// Run with:  env $OB_TEST_ENV node --no-concurrent-sparkplug --no-concurrent-recompilation --import tsx --import ./engine/src/test-database-bypass.ts --test --test-force-exit --test-reporter=tap engine/src/scripting-custom-gl-lines.integration.test.ts   (from repo root)
//
