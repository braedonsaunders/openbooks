...
// role), an identical runtime login outside dev/test, or an unowned table
// each refuse by name. Same predicate bootstrap.ts enforces, so this fails
// when the rule weakens. (Lock ordering and seed-guard posture remain
