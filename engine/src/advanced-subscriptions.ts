...
/**
 * Called by the recurring runner before it claims a due row. Basic
 * subscriptions have no contract lifecycle and return true. Manual/no-renew contracts stop at the boundary;
...
/** Snapshot used by the invoice engine; null means basic single-plan billing. */
