...
/**
 * Create a customer invoice for a subscription charge. Basic subscriptions
 * supply scalar fields and remain one line; lifecycle-managed subscriptions supply
