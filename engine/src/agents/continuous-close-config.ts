...
export const CONTINUOUS_CLOSE_AGENT_KEYS = [
  "accounting",
  "finance",
  "collections",
  "payables",
...
export const CONTINUOUS_CLOSE_DETECTOR_SPECS = [
  ...
  {
    detectorKey: "broken_payment_promise",
    agentKey: "collections",
    supportsMateriality: true,
    parameters: [
      {
        key: "breachToleranceDays",
        defaultValue: 3,
        min: 0,
        max: 30,
        step: 1,
  ...
  {
    detectorKey: "credit_hold_candidate",
    agentKey: "collections",
    supportsMateriality: true,
    parameters: [
      {
  ...
  {
    detectorKey: "bills_due_before_payrun",
    agentKey: "payables",
    supportsMateriality: true,
    parameters: [
      {
        key: "payRunHorizonDays",
        defaultValue: 7,
        min: 1,
        max: 30,
        step: 1,
  ...
  {
    detectorKey: "early_pay_discount_opportunity",
    agentKey: "payables",
    supportsMateriality: true,
    parameters: [
      {
        key: "minimumDiscountPercent",
        defaultValue: 2,
        min: 0,
        max: 100,
        step: 1,
  ...
  {
    detectorKey: "bills_missing_approval",
    agentKey: "payables",
    supportsMateriality: true,
    parameters: [
      {
  ...
  {
    detectorKey: "bank_line_match_candidate",
  ...
  {
    detectorKey: "stale_reconciliation",
    agentKey: "reconciliation",
    supportsMateriality: true,
    parameters: [
      {
  ...
  {
    detectorKey: "never_reconciled_account",
    agentKey: "reconciliation",
    supportsMateriality: true,
    parameters: [
      {
  ...
  {
    detectorKey: "control_account_type_mismatch",
    agentKey: "hygiene",
    supportsMateriality: false,
    parameters: [],
  },
  {
    detectorKey: "duplicate_party_identity",
    agentKey: "hygiene",
    supportsMateriality: false,
    parameters: [],
  },
  {
    detectorKey: "item_missing_tax_code",
    agentKey: "hygiene",
    supportsMateriality: false,
    parameters: [],
  },
  {
    detectorKey: "project_missing_cost_budget",
    agentKey: "hygiene",
    supportsMateriality: false,
    parameters: [],
  },
  {
    detectorKey: "budget_scenario_without_lines",
    agentKey: "hygiene",
    supportsMateriality: false,
    parameters: [],
  },
  {
    detectorKey: "unmapped_payroll_component",
    agentKey: "hygiene",
    supportsMateriality: false,
    parameters: [],
  },
